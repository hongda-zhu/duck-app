function registUser(name, lastName, mail, password, age, callback) {
    ...
    call('POST', 'https://hongdazhu86.herokuapp.com/api/user', undefined, { 'username': mail, 'password': password, 'name': name, 'lastName': lastName, 'age': age.toString() }, result => {
        if (result.error) {
...
/* 
}call('POST', 'https://hongdazhu86.herokuapp.com/api/user', { name, surname, username: email, password }, result => {
